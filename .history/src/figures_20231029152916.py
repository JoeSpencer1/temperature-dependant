...
ax1.errorbar(n, Ti25250E, yerr = εTi25250E, color = 'blue', label = "250˚C")
...
ax2.errorbar(n1, Ti25250σ, yerr = εTi25250σ, color = 'blue', label = "250˚C")
ax2.errorbar(n1, Ti500σ, yerr = εTi500σ, color = 'red', label = "250˚C")
ax2.set_yscale('log')
ax2.set_ylim([10, 600])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
