...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(12, 5))
ax1.errorbar(n, Ti250E, yerr = εTi250E, color = 'red', label = "250˚C/250˚C")
ax1.errorbar(n, Ti25250E, yerr = εTi25250E, color = 'blue', label = "250˚C/25˚C")
ax1.errorbar(n, Ti500E, yerr = εTi500E, color = 'gray', label = "250˚C/500˚C")
ax1.set_yscale('log')
ax1.set_ylim([0.5, 200])
ax1.set_xlim([0, 21])
ax1.set_xticks([0, 5, 10, 15, 20])
...
ax2.errorbar(n1, Ti250σ, yerr = εTi250σ, color = 'red', label = "250˚C/250˚C")
ax2.errorbar(n1, Ti25250σ, yerr = εTi25250σ, color = 'blue', label = "250˚C/25˚C")
ax2.errorbar(n1, Ti500σ, yerr = εTi500σ, color = 'gray', label = "250˚C/500˚C")
ax2.set_yscale('log')
ax2.set_ylim([10, 600])
ax2.set_xlim([-0.5, 21])
ax2.set_xticks([0, 5, 10, 15, 20])
